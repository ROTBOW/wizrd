...
import ChatContainer2 from './chat/ChatContainer2';
...
const App = () => (
  <div>
    ...
    <Switch>
      ...
      <ProtectedRoute exact path="/chat/1" component={ChatContainer} />
      <ProtectedRoute exact path="/chat/2" component={ChatContainer2} />
      <AuthRoute exact path="/" component={temp} />
    </Switch>
  </div>
);
