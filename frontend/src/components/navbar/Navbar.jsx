        ...
        <div className={styles.inner}>
          ...
          <div className={styles.searchWrapper}>
            <form className={styles.searchBar}>
              ...
              <input className={styles.searchInput} id="searchInput" type="text" placeholder="Search for lesson, music, and more" value={searchValue} onChange={(e) => setSearchValue(e.target.value)} />
