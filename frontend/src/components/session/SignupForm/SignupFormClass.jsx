        ...
        <section className={styles.authSectionWrapper}>
          ...
          <div className={styles.formWrapper}>
            <form className={styles.form} onSubmit={this.handleSubmit}>
              <label>Username:
                <input type="text" required spellCheck="false" value={this.state.username} onChange={this.update('username')}placeholder="Your username" />
              </label>

              <label>Email:
                <input type="email" required value={this.state.email} onChange={this.update('email')} placeholder="Your email" />
              </label>

              <label>Password:
                <input type="password" required value={this.state.password} onChange={this.update('password')} placeholder="Your password" />
              </label>

              <label>Confirm your password:
                <input type="password" required value={this.state.password2} onChange={this.update('password2')} placeholder="Your password" />
              </label>
